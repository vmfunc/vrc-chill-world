    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                clip((round(sin((i.uv0.g*_Density)))+round(sin((i.uv0.r*_Density)))) - 0.5);
...
////// Specular:
                ...
                float3 diffuseColor = node_174; // Need this for specular when using metallic
